...
public class SectionProfileActivityAdapter extends RecyclerView.Adapter<SectionProfileActivityAdapter.ViewHolder> {

    private List<String> mUsersList;
    private Context ctx;

    SectionProfileActivityAdapter(List<String> mUsersList, Context ctx) {
    ...
    @NonNull
    @Override
    public SectionProfileActivityAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.user_single_layout ,parent, false);

        return new SectionProfileActivityAdapter.ViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(@NonNull final SectionProfileActivityAdapter.ViewHolder viewHolder, int i) {
